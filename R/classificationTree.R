...
# plot tree 
png(filename="~/RMeter3/R/Wykresy/ClassificationTree.png");
...
rpart::post(fit, file = "~/RMeter3/R/Dane/ClassificationTree.ps", 
...
png(filename="~/RMeter3/R/Wykresy/ClassificationPrunedTree.png");
plot(pfit, uniform=TRUE, 
     main="Pruned Classification Tree for build status");
text(pfit, use.n=TRUE, all=TRUE, cex=.8);
dev.off();

rpart::post(pfit, file = "~/RMeter3/R/Dane/ClassificationPrunedTree.ps", 
...
write.table(tofile,file="~/RMeter3/R/MacierzeKorelacji/ConfMatrixPrunedClassTree.txt",sep='\t');
