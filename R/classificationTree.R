...
# plot tree 
png(filename="~/RMeter/R/Wykresy/ClassificationTree.png");
...
rpart::post(fit, file = "~/RMeter/R/Dane/ClassificationTree.ps", 
...
png(filename="~/RMeter/R/Wykresy/ClassificationPrunedTree.png");
plot(pfit, uniform=TRUE, 
     main="Pruned Classification Tree for build status");
text(pfit, use.n=TRUE, all=TRUE, cex=.8);
dev.off();

rpart::post(pfit, file = "~/RMeter/R/Dane/ClassificationPrunedTree.ps", 
...
write.table(tofile,file="~/RMeter/R/MacierzeKorelacji/ConfMatrixPrunedClassTree.txt",sep='\t');
